...
X = tf.placeholder(tf.float32, [None, 28, 28, 1]) # 1 is the image depth for MNIST greyscale image.
y = tf.placeholder(tf.float32, [None, 10])
pkeep = tf.placeholder(tf.float32)

L1 = 16 # number of filters in first convolutional
L2 = 32 # number of filters in second convolutional filters
L3 = 64 # Fully Connected layer

# 3 x 3 filter size, with pixel depth 1 and output size L1
